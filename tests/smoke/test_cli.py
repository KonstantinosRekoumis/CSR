...
def test_dry_cli_run_doesnt_explode():
    main(MOCK_SHIP_JSON_PATH, False, False)


def test_dry_cli_ship_plots_run_doesnt_explode():
    main(MOCK_SHIP_JSON_PATH, True, False)


def test_dry_cli_ship_pressure_plots_run_doesnt_explode():
    main(MOCK_SHIP_JSON_PATH, True, True)
